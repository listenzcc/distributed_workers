...
- [BCI 通信报文](#bci-%e9%80%9a%e4%bf%a1%e6%8a%a5%e6%96%87)
  ...
  - [发送包](#%e5%8f%91%e9%80%81%e5%8c%85)
    ...
    - [运动指令包](#%e8%bf%90%e5%8a%a8%e6%8c%87%e4%bb%a4%e5%8c%85)
...
| 在线 | BCI -> UI    | 心跳包，运动指令包，运行时错误包，在线准确率包（仅在在线实验结束后发送） |
...
```json
{
  ...
  "zhenshibiaoqian": "1", // 上一个动作的真实标签，1代表运动，2代表静息，这里的1是例子
  "timestamp": "1585297645.123"
}
```
...
{
  "mode": "QueryReply",
  "gujibiaoqian": "1", // 上一个动作的预测标签，1代表运动，2代表静息，这里的1是例子
  "timestamp": "1585297645.123"
}
```
